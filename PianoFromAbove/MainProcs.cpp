...
INT_PTR WINAPI LibDlgProc( HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam )
{
    ...
    switch(msg)
    {
        case WM_INITDIALOG:
        {
            ...
            int aFmt[2] = { LVCFMT_LEFT, LVCFMT_LEFT};//, LVCFMT_RIGHT, LVCFMT_RIGHT, LVCFMT_RIGHT };
            int aCx[2] = { 166, 150};//, 40, 32, 49 };
            TCHAR *aText[2] = { TEXT( "File" ), TEXT( "Directory" )}; //, TEXT( "Time" ), TEXT( "Trks" ), TEXT( "Notes/s" ) };
