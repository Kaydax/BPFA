...
LRESULT WINAPI WndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
  ...
  case WM_COMMAND:
  {
    ...
    case ID_FILE_PRACTICESONG: case ID_FILE_PRACTICESONGCUSTOM:
    {
      ...
      ofn.lpstrTitle = TEXT("Select MIDI");
    ...
    case ID_FILE_CLOSEFILE:
    {
      ...
      updateDiscordPresence("Currently doing nothing", "");
    ...
    case ID_HELP_DISCORD:
      ShellExecute(NULL, L"open", L"https://discord.gg/5sMugcQ", NULL, NULL, SW_SHOWNORMAL);
      return 0;
    case ID_GAMEERROR:
...
BOOL PlayFile(const wstring& sFile, bool bCustomSettings, bool bLibraryEligible)
{
  ...
  _bstr_t currently_playing(sFile.c_str() + (sFile.find_last_of(L'\\') + 1));
  updateDiscordPresence(currently_playing, "Playing a MIDI");
