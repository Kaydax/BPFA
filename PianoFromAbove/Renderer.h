...
public:
	...
	virtual HRESULT DrawSkew(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4, DWORD c1, DWORD c2, DWORD c3, DWORD c4) = 0;
...
public:
	...
	HRESULT DrawRect(float x, float y, float cx, float cy, DWORD c1, DWORD c2, DWORD c3, DWORD c4);
  static inline HRESULT DrawRectBatch(float x, float y, float cx, float cy, DWORD c1, DWORD c2, DWORD c3, DWORD c4);
  static inline void GenRect(float x, float y, float cx, float cy, DWORD c1, DWORD c2, DWORD c3, DWORD c4, SCREEN_VERTEX* v);
...
inline void D3D9Renderer::GenRect(float x, float y, float cx, float cy, DWORD c1, DWORD c2, DWORD c3, DWORD c4, SCREEN_VERTEX* v)
{
  x -= 0.5f;
  y -= 0.5f;
